...
class CreateTourOperatorBlogCostExclusivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('blog_cost_exclusives', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('cost_exclusive');
        ...
        Schema::table('blog_cost_exclusives',function(Blueprint $table){
    ...
    {
        Schema::dropIfExists('tour_operator_blog_cost_exclusives');
    }
}
