...
class CreateSoloBookingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('solo_bookings', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('group_travel_category');
            ...
            $table->string('solo_trip_public_status')->default(0);
            $table->unsignedBigInteger('tour_operators_id');
            $table->unsignedBigInteger('tour_operators_blogs_id');
            $table->unsignedBigInteger('users_id');
            $table->timestamps();
        });
        Schema::table('solo_bookings',function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('solo_bookings');
    }
}
