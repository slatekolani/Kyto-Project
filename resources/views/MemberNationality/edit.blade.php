...
@section('content')
    ...
    {{ Form::model($member_nation,['enctype="multipart/form-data"','route' => ['MemberNationality.update', $member_nation->uuid], 'method'=>'put','autocomplete' => 'off',
                  'id' => 'update','class' => 'form-horizontal  needs-validation', 'novalidate']) }}
    {{ Form::hidden('id', $member_nation->id, []) }}
    <section class="card">
        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::text('nation_name', $member_nation->nation_name, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'nation_name', 'required']) }}
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                <img src="{{url('public/nationFlags/',$member_nation->nation_flag)}}" style="width:50px;height:50px">
