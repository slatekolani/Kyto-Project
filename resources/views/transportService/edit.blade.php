...
@section('content')
    ...
    {{ Form::model($transport_service,['route' => ['transportService.update', $transport_service->uuid], 'method'=>'put','autocomplete' => 'off',
              'id' => 'update','class' => 'form-horizontal  needs-validation', 'novalidate']) }}
    {{ Form::hidden('id', $transport_service->id, []) }}
    <section class="card">
        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::text('transport_name', $transport_service->transport_name, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'transport_name', 'required']) }}
