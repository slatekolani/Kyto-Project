...
@section('content')
    ...
    {{ Form::model($special_care_category,['route' => ['specialCare.update', $special_care_category->uuid], 'method'=>'put','autocomplete' => 'off',
              'id' => 'update','class' => 'form-horizontal  needs-validation', 'novalidate']) }}
    {{ Form::hidden('id', $special_care_category->id, []) }}
    <section class="card">
        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::text('special_care', $special_care_category->special_care, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'special_care', 'required']) }}
