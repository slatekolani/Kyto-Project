@extends('layouts.main', ['title' => __("Edit Tanzania Tour Operator"), 'header' => trans("Edit Tanzania Tour Operator")])
...
@section('content')
    ...
    {{ Form::model($tour_operator,['enctype="multipart/form-data"','route' => ['tourOperator.update', $tour_operator->uuid], 'method'=>'put','autocomplete' => 'off',
    'id' => 'update','class' => 'form-horizontal  needs-validation', 'novalidate']) }}
    {{ Form::hidden('id', $tour_operator->id, []) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::text('company_name', $tour_operator->company_name, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'company_name', 'required']) }}
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::tel('phone_number', $tour_operator->phone_number, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'phone_number', 'required']) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::email('email_address', $tour_operator->email_address, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'email_address', 'aria-describedby' => 'emailHelp', 'required']) }}
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <table>
                            ...
                            <tr>
                                <td> <input class="form-control" type="text" name="company_operating_regions1" value="{{$tour_operator_address->company_operating_regions}}" required></td>
                                <td><input class="form-control" type="text" name="company_address1" value="{{$tour_operator_address->company_address}}" required></td>
                                <td><input class="form-control" type="text" name="company_contact1" value="{{$tour_operator_address->company_contact}}" required><td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::url('company_website_url', $tour_operator->company_website_url, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'company_website_url', 'placeholder'=>'http://kytotz.com','required']) }}
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::url('company_instagram_url', $tour_operator->company_instagram_url, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'company_instagram_url', 'placeholder'=>'https://www.instagram.com/kytotz/','required']) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {{ Form::url('GPS_link', $tour_operator->GPS_link, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'GPS_link','required']) }}
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                {{ Form::label('whatsapp_direct_link', __("WhatsApp URL"), ['class' => 'required_asterik']) }}
                                {{ Form::url('whatsapp_direct_link', $tour_operator->whatsapp_direct_link, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'whatsapp_direct_link','required']) }}
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                <img src="{{url('public/logo_uploads/Logo/',$tour_operator->logo)}}" style="width:100px;height:100px">
