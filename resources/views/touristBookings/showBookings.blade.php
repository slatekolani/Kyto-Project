    ...
    <div class="container">
        <div class="content-body">
            ...
            <div class="row" style="padding-top: 20px">
                <div class="col-md-9">
                    @foreach(Auth::user()->getUserTourBookings() as $tourist_booking)
                        <div class="card" style="border: 2px solid gainsboro">
                            <div class="card-body">
                                <div class="end_contents" style="border-bottom: 1px solid gainsboro">
                                    <img src="{{asset('public/logo_uploads/Logo/'.$tourist_booking->tourOperators->logo)}}"
                                         style="width:70px;height:70px">
                                    <h4 style="padding-left: 10px">Trip with {{$tourist_booking->tourOperators->company_name}}</h4>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <a href="{{route('payments.show',$tourist_booking->uuid)}}" style="float:right"><button class="btn btn-primary btn-sm"> Payment history&rarr;</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div style="padding-top:5px;border-bottom: 1px solid gainsboro">
                                    <table class="table table-hover table-responsive-md">
                                        <tr>
                                            ...
                                            <td>{{\App\Models\MemberNations\MemberNationality::find($tourist_booking->tourist_nation)->nation_name}}</td>
                                        </tr>
                                        <tr>
                                            <th>No.Travellers</th>
                                            <td>{{$tourist_booking->number_of_tourists}}</td>
                                            <th>Trip to</th>
                                            <td>{{\App\Models\touristAttraction\touristAttraction::find($tourist_booking->tourOperatorsBlogs->blog_topic)->attraction_name}}</td>
                                        </tr>
                                        <tr>
                                            <th>Start date</th>
                                        ...
                                        <tr>
                                            <th>Due payment</th>
                                            <td>{{$tourist_booking->tourOperatorsBlogs->payment_range}}</td>
                                            <th>Trip status</th>
...
{{--                                                First inner container--}}
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        @if($tourist_booking->status==0)
                                                            <td>
                                                                    <button onclick="alert('You are not legible to rate the tour operator. Seems you have not conducted a safari with this tour operator. Please wait!')">Rate</button></td><td>
                                                                @else
                                                                    <button class="btn btn-primary btn-sm rate_button" value="{{$tourist_booking->tourOperators->id}}">Rate</button>
                                                            </td>
                                                        @endif
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                                ...
                                                                @else
                                                                <button onclick="alert('Sorry you cannot make changes when the trip is approved. Contact the tour operator to request change')">Adjust</button>
                                                                @endif
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        @if($tourist_booking->status==1)
                                                            @if($tourist_booking->tourist_nation==1)
                                                                @if(((Auth::user()->getAmountPaid($tourist_booking)) >= (Auth::user()->getTripCostLocal($tourist_booking))))
                                                                    <button onclick="alert('Congrats! Payment complete. No more payment service for this trip')">
                                                                        Pay Bill
                                                                    </button>
                                                                @elseif(((Auth::user()->getAmountPaidNonVerifiedAndVerified($tourist_booking))>=(Auth::user()->getTripCostLocal($tourist_booking))))
                                                                    <button onclick="alert('Seems the transactions done are enough for this trip cost. Please wait for your transactions to be verified')">
                                                                        Pay Bill
                                                                    </button>
                                                                @else
                                                            ...
                                                            @endif
                                                        @else
                                                            <button onclick="alert('You are only allowed to pay the bill when you are verified to pay by the tour operator.Please wait!')">Pay bill</button>
                                                        @endif
                                ...
                                <div class="container">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="myModal{{$tourist_booking->tourOperators->id}}"
                                         role="dialog">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <div class="row" style="display: flex">
                                                        ...
                                                        <div class="col-md-10" style="top:-10px;padding-left: 30px">
                                                            <h4>{{$tourist_booking->tourOperators->company_name}}</h4>
                                                        </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input name="tour_operators_id"
                                                           value="{{$tourist_booking->tourOperators->id}}" hidden>
