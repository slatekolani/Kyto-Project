<table class="table table-hover table-responsive-md" id="unverified_trip_bookings_table">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#unverified_trip_bookings_table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('touristBookings.getUnverifiedTrips',$tour_operator->id) }}',
                columns: [
