...
@section('content')
    ...
    {{ Form::open(['route' => 'soloBookings.store', 'autocomplete' => 'off','method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <small id="emailHelp"
                                                   class="form-text text-muted">{{ __("Number of travellers determines your bill, maximum number is ") }}<span class="badge badge-pill badge-success" style="font-size: 12px">{{$tour_operator_blogs->maximum_travellers}}</span></small>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            {{ Form::label('trip_code', __("Enter your Trip Code"), ['class' => 'required_asterik']) }}
                                            {{ Form::text('trip_code', null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'trip_code', 'required']) }}
                                            <small class="form-text text-muted">{{ __("This is a passcode for inviting your Trip Pals") }}</small>
                                            {!!  $errors->first('trip_code', '<span class="badge badge-danger">:message</span>') !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            {{ Form::label('group_travel_category', __("Category of Travellers"), ['class' => 'required_asterik']) }}
                                            {{ Form::text('group_travel_category', null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'group_travel_category','placeholder'=>'School,Organisation', 'required']) }}
                                            {!!  $errors->first('group_travel_category', '<span class="badge badge-danger">:message</span>') !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body" style="border: 2px solid gainsboro">
                        ...
                        <div class="container">
                            ...
                            @if(!empty($tour_operator_accounts) && $tour_operator_accounts->count())
                                ...
                                @endforeach
                            @else
                                <span>This tour operator didn't put their accounts public. Please <a href="mailTo:{{$tour_operator_blogs->tourOperators->email_address}}"> contact </a> them to get more info</span>
                            @endif
