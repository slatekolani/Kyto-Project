@extends('layouts.main', ['title' => trans('Unverified Solo Trips'), 'header' => trans('Unverified Solo Trips')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:400%">
                @include('touristBookings.SoloBookings.UnverifiedSoloTrips.get_unverified_solo_trips')
            </section>
        </div>
