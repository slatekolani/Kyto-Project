@extends('layouts.main', ['title' => trans('Recent Solo Trip Bookings'), 'header' => trans('Recent Solo Trip Bookings')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:400%">
                @include('touristBookings.SoloBookings.RecentSoloTripBookings.get_recent_solo_trip_bookings')
            </section>
        </div>
