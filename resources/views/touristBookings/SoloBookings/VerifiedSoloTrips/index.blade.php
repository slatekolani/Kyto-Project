@extends('layouts.main', ['title' => trans('Verified Solo Trips'), 'header' => trans('Verified Solo Trips')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:400%">
                @include('touristBookings.SoloBookings.VerifiedSoloTrips.get_verified_solo_trips')
            </section>
        </div>
