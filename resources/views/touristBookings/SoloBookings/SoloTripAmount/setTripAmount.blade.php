...
@section('content')
    ...
    {{ Form::open(['route' => 'SoloTripAmount.store', 'autocomplete' => 'off','method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::number('amount_to_be_paid', null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'amount_to_be_paid', 'required']) }}
