<table class="table table-hover table-responsive-md" id="recent_solo_trips_to_be_conducted">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#recent_solo_trips_to_be_conducted').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('soloBookings.get_recent_solo_trips_to_be_conducted',$tour_operator->id) }}',
                columns: [
