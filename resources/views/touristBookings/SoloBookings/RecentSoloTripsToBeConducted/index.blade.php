@extends('layouts.main', ['title' => trans('Recent Solo Trips To Be Conducted'), 'header' => trans('Recent Solo Trips To Be Conducted')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:400%">
                @include('touristBookings.SoloBookings.RecentSoloTripsToBeConducted.get_recent_solo_trips_to_be_conducted')
            </section>
        </div>
