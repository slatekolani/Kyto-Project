<table class="table table-hover table-responsive-md" id="Verified_trip_payments">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table=$('#Verified_trip_payments').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('payments.getVerifiedTripPayments',$tour_operator->uuid) }}',
                columns: [
