<table class="table table-hover table-responsive-md" id="Unverified_trip_payments">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table=$('#Unverified_trip_payments').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('payments.getUnverifiedTripPayments',$tour_operator->uuid) }}',
                columns: [
