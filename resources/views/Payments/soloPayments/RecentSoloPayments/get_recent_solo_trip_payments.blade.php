<table class="table table-hover table-responsive-md" id="Recent-Solo-payments">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#Recent-Solo-payments').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('soloBookingPayments.get_recent_solo_trip_payments',$tour_operator->uuid) }}',
                columns: [
