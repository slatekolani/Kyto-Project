<table class="table table-hover table-responsive-md" id="Solo-payments">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#Solo-payments').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('soloBookingPayments.get_solo_payments',$solo_booking->uuid) }}',
                columns: [
