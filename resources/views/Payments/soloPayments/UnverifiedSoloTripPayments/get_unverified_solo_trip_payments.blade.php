<table class="table table-hover table-responsive-md" id="Unverified-solo-Trip-Payments">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#Unverified-solo-Trip-Payments').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('soloBookingPayments.getUnverifiedSoloTripPayments',$tour_operator->uuid) }}',
                columns: [
